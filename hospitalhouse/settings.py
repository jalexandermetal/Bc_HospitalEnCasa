"""
Django settings for hospitalhouse project.
...
SECRET_KEY = 'django-insecure-9=s&5tcm(=)!-aluq^2*arnu+4#y4sz^ltngmmn)$p-k-xi1bg'
...
WSGI_APPLICATION = 'hospitalhouse.wsgi.application'
